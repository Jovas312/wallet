...
public class TransactionController {
    ...
    public ResponseEntity<WalletResponseDTO> deposit(@PathVariable String email, @RequestBody DepositRequestDTO depositDTO) {
        WalletResponseDTO walletResponseDTO = transactionService.deposit(depositDTO, email);
        return ResponseEntity.ok(walletResponseDTO);
    }

    @PostMapping("/transfer/{email}")
    public ResponseEntity<TransactionResponseDTO> transfer(@PathVariable String email, @RequestBody TransferRequestDTO transferDTO) {
        TransactionResponseDTO transactionResponseDTO = transactionService.transfer(transferDTO, email);
